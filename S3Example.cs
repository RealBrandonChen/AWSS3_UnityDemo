...
namespace AWSSDK.Examples
{
    public class S3Example : MonoBehaviour
    {
        ...
        // Credential set up
        public string IdentityPoolId = "your identityPoolId here";
        ...
        void Start()
        {
            // AWS initializer of the mobile/standalone SDK
            ...
            // HttpClient set up to override the http header
        ...
        // Explicitly specifying the region at the time of creating an instance of the service client
        ...
        public void PostObject()
        {
            ...
            var request = new PostObjectRequest()
            {
                ...
                // Reset the region again to change the default S3 region
                Region = _S3Region,
            };
